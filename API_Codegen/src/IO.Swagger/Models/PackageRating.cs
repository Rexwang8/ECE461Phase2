...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <value>The fraction of project code that was introduced hrough pull requests with a code review).</value>
        [Required]

        [DataMember(Name="GoodEngineeringProcess")]
        public double? GoodEngineeringProcess { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  GoodEngineeringProcess: ").Append(GoodEngineeringProcess).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(PackageRating other)
        {
            ...
            return 
                ...
                (
                    GoodEngineeringProcess == other.GoodEngineeringProcess ||
                    GoodEngineeringProcess != null &&
                    GoodEngineeringProcess.Equals(other.GoodEngineeringProcess)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (GoodEngineeringProcess != null)
                    hashCode = hashCode * 59 + GoodEngineeringProcess.GetHashCode();
                return hashCode;
            }
        }
